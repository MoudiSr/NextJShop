    ...
    return (
        <div key={id} className="group border-gray-100/30 m-8 flex w-full max-w-xs flex-col self-center overflow-hidden rounded-lg border bg-gray-700 shadow-md">
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <a onClick={() => handleAdd()} className="flex items-center justify-center rounded-md border border-transparent bg-[#da0037] px-5 py-2.5 text-center font-medium text-white text-xl hover:cursor-pointer">
